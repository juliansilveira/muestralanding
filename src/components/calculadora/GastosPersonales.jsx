...
const FormularioGastosPersonales = ({ onNext }) => {
  // Lista de categorías
  const categorias = [
    "Ahorro",
    "Vivienda / Alquiler",
    "Seguros / Impuestos inmobiliarios",
    "Agua",
    "Luz",
    "Gas",
    "Internet",
    ...
    "Ropa y calzado",
    "Seguros de vida",
    "Salud (Visitas al doctor, dentista, etc…)",
    "Colegiaturas",
    "Tarjetas de crédito",
  ];
  ...
  return (
    <div className="font-poppins mx-auto bg-white sm:p-6 lg:p-8 rounded-lg shadow-md max-w-screen-sm md:max-w-2xl lg:max-w-4xl sm:w-full">
      <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-4 sm:mb-6 text-gray-800 flex items-center">
        ...
        <div className="relative group ml-2 inline-block">
          ...
          <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-64 p-2 text-xs text-white bg-pink-300 rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity">
            Aquí introduces tus gastos fijos y variables mensuales por
            categoría. Ingresa cada monto y haz clic en "Siguiente" para ver el
            total y avanzar al siguiente paso.
          </div>
        </div>
      </h2>
...
export default FormularioGastosPersonales;
